...
public class DangNhap extends JFrame {
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (resultSet.next()) {
                        // Login successful
                        new View(); // Assuming View() is the class to display after login
                        dispose();// Đóng JFrame đăng nhập
                    } else {
                        JOptionPane.showMessageDialog(null, "Sai mật khẩu hoặc tài khoản, vui lòng kiểm tra lại !");
                    }

                    JDBCUtil.closeConnection(connection); // Close the connection
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                DangNhap frame = new DangNhap();// Create an instance of your login frame
