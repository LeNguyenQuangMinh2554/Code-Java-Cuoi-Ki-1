...
import Controller.ControllerSuaSanPham;
...
public class SuaSanPham extends JPanel {
	...
	private ControllerSuaSanPham controller;
	...
	public SuaSanPham() {
		...
		add(panel);
		add(panel_4, new GridLayout(1, 1));
		...
		controller = new ControllerSuaSanPham(this);
		showTableData();
		revalidate();
		repaint();
	}
	...
	public void addThemButtonListener(ActionListener listener) {
		getBtnNewButton().addActionListener(listener); // Chỉnh sửa: Gắn sự kiện cho nút Thêm
	}
