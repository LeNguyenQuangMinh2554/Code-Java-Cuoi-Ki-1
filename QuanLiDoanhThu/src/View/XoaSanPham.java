...
import Controller.ControllerXoaSanPham;
import javax.swing.ScrollPaneConstants;
import java.awt.Color;
import java.awt.FlowLayout;

public class XoaSanPham extends JPanel {
	private static final long serialVersionUID = 1L;
	private JTextField textField;
	private JTable table;
	private JButton btnNewButton;
	private ControllerXoaSanPham controller;
	...
	public XoaSanPham() {
		...
		jPanel3.add(getBtnNewButton());
		panel_3.add(jPanel3);

		controller = new ControllerXoaSanPham(this);
		showTableData();
		revalidate();
		repaint();
	}
